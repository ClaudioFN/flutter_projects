...
import 'package:project_pomodoro/components/cronometro_component.dart';
import 'package:project_pomodoro/components/entrada_tempo_component.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          Expanded(child: CronometroComponent()),
          Padding(
